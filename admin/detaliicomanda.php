	...
	<body>
		<table cellpadding="0" cellspacing="0" border="1" width="100%" height="100%">
			<tr style="height: 50px; width: 100%;">
				<td colspan="2" style="font-weight: bold; text-align: center; height: 50px; width: 100%; font-family: Tahoma, Verdana, Arial; font-size: 10pt;">Detalii comanda</td>
			</tr>
			<tr>
					...
					<table cellpadding="5" cellspacing="0" border="0" width="700" class="modelspecs">
						...
						<tr bgcolor="#F0E7D8">
							<td align="center" colspan="2">
								<a href="comenzi.php" class="genLink" style="width: 100px;"> &nbsp; Inapoi &nbsp; </a><br><br>								</td>
						</tr>
					</table>
				</td>
			</tr>
