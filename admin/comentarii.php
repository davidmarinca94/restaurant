	...
	<body>
		<table cellpadding="0" cellspacing="0" border="1" width="100%" height="100%">
			<tr style="height: 50px; width: 100%;">
				<td colspan="2" style="font-weight: bold; text-align: center; height: 50px; width: 100%; font-family: Tahoma, Verdana, Arial; font-size: 10pt;">Administrare comentarii</td>
			</tr>
			<tr>
				...
				<td style="width: 700px;" valign="top" align="center">
					<?php
						...
						echo "<td width=\"300\">Comentariu</td>";
						...
						$strfComentariu = $row['fComentariu'];
							...
							echo "<td align=\"center\" width=\"200\">$strfComentariu</td>\n";
							

							echo "<td align=\"center\" width=\"100\">$strAprobat</td>\n";
							echo "<td align=\"center\" width=\"100\">$strLinkAproba</td>\n";
							
							echo "<td align=\"center\" width=\"100\"><a  href=\"detaliicomentariu.php?intIdComentariu=$intIdComentariu\"><img src=\"../images/view.gif\" border=\"0\"></a></td>\n";
