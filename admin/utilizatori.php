	...
	<body>
		<table cellpadding="0" cellspacing="0" border="1" width="100%" height="100%">
			<tr style="height: 50px; width: 100%;">
				<td colspan="2" style="font-weight: bold; text-align: center; height: 50px; width: 100%; font-family: Tahoma, Verdana, Arial; font-size: 10pt;"> Administrare utilizatori</td>
			</tr>
			<tr>
				...
				<td style="width: 700px;" valign="top" align="center">
					<?php
						...
						while ($row = mysql_fetch_array($result)) {
							...
							echo "<td align=\"center\" width=\"100\"><a  href=\"detaliiutilizator.php?intIdUtilizator=$intIdUtilizator\"><img src=\"../images/view.gif\" border=\"0\"></a></td>\n";
