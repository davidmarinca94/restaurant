...
<?php fInsertDocType(); ?>
<head>
<title>Inregistrare terminata</title>
<?php fInsertMetaTags(); ?>
<?php fInsertCSS(); ?>
<?php fInsertJS(); ?>
</head>
			...
			<td>
				<table class="contenttable">
					<tr>
						...
						<tr><td>
						<!--START CONTENT-->
						<h1 class="pageheader">Inregistrare terminata</h1>
						<p class="pagecontent">
							Felicitari,<br />
							Procesul de inregistrare a fost incheiat. Va multumim pentru alegerea facuta.
						</p>
						<!--END CONTENT-->
						</td></tr>
						</table>
